...
import imgModernFactoryFloor from "figma:asset/057723890bebb494a0193592a91cec67fedcf247"*/

 
import imgModernFactoryFloor from "../../assets/057723890bebb494a0193592a91cec67fedcf247.png";
import imgModernFinanceOffice from "../../assets/3ba19eec4fd3cf07fba6be8524f24fddb8d27558.png";
import imgHighTechWarehouse from "../../assets/c536d79bf67cf656cf1185c7e390cf1aac19463c.png";
...
function IndustryLeadersSection() {
  ...
  <IndustryCard
            ...
            company="LOGISCALE"
            metric="98.9%"
            metricLabel="Customer Satisfaction Enhanced"
            quote="Elevating customer experiences with precision and care."
          />
...
function CTASection() {
  return (
    // <section style={{ padding: "0 24px 48px" }} className="hp-final-cta">
  ...
  <section className="hp-final-cta">
      ...
      <div className="hp-inner">
        <div className="hp-cta-inner">
          <h2 className="hp-cta-title">See How Bizak Can Transform Your Business</h2>
          <p className="hp-cta-sub">
             Join thousands of leaders who have modernized their business operations with Bizak.
          </p>
          <div className="hp-cta-btns">
            <button className="hp-cta-btn-primary">Request Demo</button>
            <button className="hp-cta-btn-outline">Talk to Sales</button>
          </div>
        </div>
      </div>
    </section>
